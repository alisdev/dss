 ...
 */
package eu.europa.esig.dss.compatibility.v54.validation.reports;
...
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlBasicBuildingBlocks;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlCertificate;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlChainItem;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlConclusion;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlConstraint;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlConstraintsConclusion;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlName;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlSignature;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlSubXCV;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlValidationCertificateQualification;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlValidationProcessTimestamps;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlValidationSignatureQualification;
import eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.XmlXCV;
...
import eu.europa.esig.dss.compatibility.v54.validation.policy.Context;
...
public class DetailedReport {
	...
	private final eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport jaxbDetailedReport;

	public DetailedReport(eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport jaxbDetailedReport) {
	...
	public eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport getJAXBModel() {
	...
	public XmlConclusion getCertificateXCVConclusion(String certificateId) {
		if (jaxbDetailedReport.getCertificate() == null) {
			throw new RuntimeException("Only supported in report for certificate");
		}
		List<XmlBasicBuildingBlocks> basicBuildingBlocks = jaxbDetailedReport.getBasicBuildingBlocks();
		for (XmlBasicBuildingBlocks xmlBasicBuildingBlocks : basicBuildingBlocks) {
