...
import eu.europa.esig.dss.compatibility.v54.jaxb.parsers.DigestMatcherTypeParser;
    ...
    extends XmlAdapter<String, DigestMatcherType>
{
    ...
    public DigestMatcherType unmarshal(String value) {
        return (DigestMatcherTypeParser.parse(value));
    }

    public String marshal(DigestMatcherType value) {
        return (DigestMatcherTypeParser.print(value));
    }
