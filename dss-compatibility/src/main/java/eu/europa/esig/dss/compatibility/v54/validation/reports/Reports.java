...
public class Reports extends AbstractReports {
	 ...
	 */
	protected eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport simpleReport;
	 ...
	 */
	public Reports(final eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData diagnosticDataJaxb,
			final eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport detailedReport, final eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport simpleReport) {
	 ...
	 */
	public eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport getSimpleReportJaxb() {
		return simpleReport;
	}
	...
	public String getXmlSimpleReport() {
		if (xmlSimpleReport == null) {
			xmlSimpleReport = getJAXBObjectAsString(simpleReport, eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport.class.getPackage().getName(),
