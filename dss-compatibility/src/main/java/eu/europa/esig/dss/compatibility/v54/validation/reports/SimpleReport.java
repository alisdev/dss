...
import eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.XmlSignature;
...
public class SimpleReport {
	...
	private final eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport wrapped;

	public SimpleReport(final eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport wrapped) {
	 ...
	 */
	public eu.europa.esig.dss.compatibility.v54.jaxb.simplereport.SimpleReport getJaxbModel() {
		return wrapped;
	}
