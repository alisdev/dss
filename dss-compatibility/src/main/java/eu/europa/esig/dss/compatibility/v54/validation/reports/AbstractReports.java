...
import eu.europa.esig.dss.compatibility.v54.validation.reports.wrapper.DiagnosticData;
...
public abstract class AbstractReports {
	 ...
	 */
	protected eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData diagnosticData;
	 ...
	 */
	protected eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport detailedReport;
	 ...
	 */
	protected AbstractReports(final eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData diagnosticDataJaxb,
			final eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport detailedReport) {
	 ...
	 */
	public eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData getDiagnosticDataJaxb() {
	 ...
	 */
	public eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport getDetailedReportJaxb() {
	...
	public String getXmlDiagnosticData() {
		if (xmlDiagnosticData == null) {
			xmlDiagnosticData = getJAXBObjectAsString(diagnosticData, eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData.class.getPackage().getName(),
	...
	public String getXmlDetailedReport() {
		if (xmlDetailedReport == null) {
			xmlDetailedReport = getJAXBObjectAsString(detailedReport, eu.europa.esig.dss.compatibility.v54.jaxb.detailedreport.DetailedReport.class.getPackage().getName(),
