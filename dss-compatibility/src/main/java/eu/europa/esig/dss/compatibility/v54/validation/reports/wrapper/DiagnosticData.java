...
import eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.XmlContainerInfo;
...
import eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.XmlTrustedList;
...
public class DiagnosticData {
	...
	private final eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData wrapped;

	private List<SignatureWrapper> foundSignatures;
	private List<CertificateWrapper> usedCertificates;

	public DiagnosticData(final eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData wrapped) {
	 ...
	 */
	public eu.europa.esig.dss.compatibility.v54.jaxb.diagnostic.DiagnosticData getJaxbModel() {
		return wrapped;
	}
